...
def test_duplicate_save_dates():
    with no_lingering_errors():
        with test_tempdir('bup-tvfs-') as tmpdir:
            ...
            wvpasseq('test', name)
            wvpasseq(('.',
                      '1970-01-01-214640-10',
                      '1970-01-01-214640-09',
                      '1970-01-01-214640-08',
                      '1970-01-01-214640-07',
                      '1970-01-01-214640-06',
                      '1970-01-01-214640-05',
                      '1970-01-01-214640-04',
                      '1970-01-01-214640-03',
                      '1970-01-01-214640-02',
                      '1970-01-01-214640-01',
                      '1970-01-01-214640-00',
                      'latest'),
